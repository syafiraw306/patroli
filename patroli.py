...
# Judul mempunyai bobot lebih tinggi.
...
if title_positive_score > 0:

    positive_score += (
        title_positive_score * 2
    )

# Konteks negatif eksplisit.
...
# ========================================================
# KOREKSI BERITA PENEGAKAN HUKUM POSITIF
# ========================================================
...
# ========================================================
# KOREKSI BERITA KEGIATAN NORMAL / POSITIF
# ========================================================
...
# Jika judul jelas kegiatan normal dan tidak ada
# indikator risiko kuat, jangan salah klasifikasi.
if (
    category == "Netral"
    and normal_activity_hits
    and not strong_context_matches
    and not danger_hits
...
# Berita terkait isu hukum yang cukup kuat
# jangan terlalu mudah menjadi Netral.
if (
    category == "Netral"
...
message = (
    ...
    f"<b>Link:</b>\n"
    f"<a href=\""
    f"{html.escape(finding.get('link', ''), quote=True)}"
    f"\">Buka Artikel</a>\n\n"
...
#
# PENTING:
# run_logs Supabase Anda hanya mempunyai:
#
# id
# created_at
# duration_seconds
...
try:
    ...
    print()
    print(
        "[PATROLI] Dihentikan oleh pengguna."
    )
